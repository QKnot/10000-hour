...
<div class="page-header">
    <h1><i class="bi bi-plus-circle"></i> Create New Blog Post</h1>
</div>
...
<div class="form-card">
    <form action="{{ route('blog.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control @error('featured_image') is-invalid @enderror" id="featured_image" name="featured_image" value="{{ old('featured_image') }}" placeholder="https://example.com/image.jpg">
